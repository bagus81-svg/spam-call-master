subrek_anying(){
xdg-open https://www.youtube.com/channel/UCGTF0HyCnpORLAw6vyf15dQ
sleep 10
}
m="\033[31;1m"
k="\033[1;33m"
...
clear
sleep 0.1
printf "${u}╔═╗╦═╗╔═╗╔╦╗     ${bi}╔═╗╔═╗╗  ╗";printf "\n${u}╚═╗╠═╝╠═╣║║║ ${m}<${h}•${m}> ${bi}║  ╠═╣║  ║";printf "\n${u}╚═╝╩  ╩ ╩╩ ╩     ${bi}╚═╝╩ ╩╚═╝╚═╝ ${k}New";printf "\n${b}══════════════════════════════════";printf "\n${b}=${m}[ ${pu}Author ${m}: ${bi}Bagus81";printf "\n${b}=${m}[ ${pu}Youtube${m}: ${bi}Maz bagus81";printf "\n${b}=${m}[ ${pu}Github ${m}: ${hg}github.com/B4N954N2-ID${p}";printf "\n${b}══════════════════════════════════";sleep 0.1;printf $p"\n[${h}+${p}] ${k}Contoh ${m}: ${p}85xxxxxxxxx\n";gaskeun_lah_anying
}#FF00EF
gaskeun_lah_anying(){
	sleep 0.5
